<template>
  ...
  <div class="h-[200px]">
    <img :src="`https://picsum.photos/seed/${post.id}/600/200`" alt="Post Thumbnail" class="rounded-4xl absolute object-cover" />
   </div>
    <p class="text-gray-700 mb-4 mt-4">{{ post.body }}</p>
